								...
								<div class="card-header">
														...
														<div class="row">
															<div class="col-lg-12">
																<div class="form-group">
																	...
																	<input class="form-control" name="nome" type="text" maxlength="119" min="10" required />
																</div>
															</div>
														</div>
														<div class="row">
														...
														<div class="row">
															...
															<div class="col-lg-6">
																<div class="form-group">
																	...
																	<input class="form-control" name="tel" type="text" min="9" data-mask="## 00000-0000" data-mask-reverse="true" maxlength="13"
																	    required/>
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-lg-6">
																<div class="form-group">
																	...
																	<input class="form-control" name="mensalidade" type="text" data-mask="###.00" data-mask-reverse="true" placeholder='R$' maxlength="7"
																	    required/>
																</div>
															</div>
															<div class="col-lg-6">
									...
									<!-- Search form -->
										...
										<form class="form-inline">
											...
											<input id="minhaEntrada" onkeyup="filtrarMorador()" title="Type in a name" class="form-control form-control-sm ml-3 w-75" type="text" placeholder="Buscar Moradores" aria-label="Buscar Moradores">
										</form>
												...
												<tr>													
													...
													<td>
														...
														<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-hidden="true" id="modal_edit_user_5">
															<div class="modal-dialog">
																<div class="modal-content">
																	<form action="" id='form_edit_morador' method="POST">
																		<div class="modal-header">
																			<h5 class="modal-title">Cadastro de Morador</h5>
																			<button type="button" class="close" data-dismiss="modal">
																				<span aria-hidden="true">&times;</span>
																		...
																		<div class="modal-body">
																			<div class="row">
																				<div class="col-lg-12">
																					<div class="form-group">
																						<label>Nome Completo (obrigatório)</label>
																						<input class="form-control" value='' name="nome" type="text" maxlength="119" required />
																					</div>
																				</div>
																			</div>
																			<div class="row">
