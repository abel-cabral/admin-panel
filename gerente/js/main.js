 ...
 function vagas_porcento(contador) {
   ...
   $.ajax({
     ...
     dataType: "JSON",
     success: function (data) {
       var votevalue = parseInt($("#r" + contador).text()) / parseInt(data) * 100;
       votevalue = ((isFinite(votevalue)) ? parseInt(votevalue) : '0'); //Aqui evitamos bug caso o número de vagas seja inferior ou igual a 0
       $("#rvagas" + contador).html(votevalue + "% Ocupada"); //Calcula a Porcentagem de Ocupação
